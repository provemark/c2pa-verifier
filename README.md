...
> be discovered: [`docs/conformance.md`](docs/conformance.md) lists 15
...
this verifier does about each and what the 15 gaps would cost.
...
- **Changes of plan are written down, not made quietly.** When a
  ...
  and confirmed by the maintainer before anything went green — 101 times so
  far: 98 confirmed, three written with SPEC-032 and awaiting confirmation.
...
- **What is missing is published too**, in
  ...
  specification, one by one, including the 15 this verifier does not yet
  meet.
