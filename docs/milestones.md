...
| SPEC-007 | Claim v1 and v2, assertion store, `claim_generator_info`, the JSON view for the sister library | draft 2026-09-21, variants measured, awaiting approval |
