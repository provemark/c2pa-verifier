...
| SPEC-002 | PNG `caBX` → bytes: draft → approval → red tests → implementation | approved 2026-09-20; 15 tests seen red (AC1 by the maintainer), AC14 fixture added; implementation next |
