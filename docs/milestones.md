...
| SPEC-010 | `Report`: the §15 codes for the claim signature and the Manifest layer's faults, verbatim; a partial report that names its checks | approved 2026-09-21; red tests next |
