...
| SPEC-001 | JPEG APP11 → manifest store bytes: draft → approval → red tests → implementation | implemented 2026-09-19: 14 tests red → green, `composer check` exit 0; AC7 kept stricter than c2patool (step 03) |
