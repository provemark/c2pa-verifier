...
| 64 | The amendment list since step 58: three, one of them group A (SPEC-015 #5, the Ed25519 verdict that depended on the PHP version) — `notes/step-64-amendments-since-58.md` | awaiting the maintainer's confirmation |
