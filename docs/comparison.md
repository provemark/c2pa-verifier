...
| Assertion content beyond the actions rules of SPEC-018, SPEC-032, SPEC-033 and SPEC-034 — `assertion.required.missing`, `assertion.action.redacted` | validated | not read (`SPEC013_NOT_YET`) — no corpus file shows a difference | M7 / a spec |
