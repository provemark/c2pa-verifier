...
it('AC1: a single piece with Z = 0 is read', function (): void {
    ...
    // The piece's data after CI, En and Z: LBox 0x3319 = 13 081, then TBox "jumb". Amendments 1 to 3:
    // the file's signature URI is not this spec's concern; SPEC-042 (deferred until box hashes) would read it.
