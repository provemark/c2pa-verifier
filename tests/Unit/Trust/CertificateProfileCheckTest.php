...
it('AC10: the codes are verbatim, and the drift alarm grows', function (): void {
    ...
    expect($values)->toHaveCount(54)   // SPEC-027 two bmffHash codes; SPEC-017 six timeStamp codes, SPEC-018 one, SPEC-020 three ingredient codes, SPEC-021 two, SPEC-022 three manifest codes, SPEC-030 four signingCredential.ocsp codes, SPEC-032 one, SPEC-033 two, SPEC-035 six
