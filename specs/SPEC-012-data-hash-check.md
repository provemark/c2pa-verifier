...
| AC3 | tests/Unit/Hash/DataHashCheckTest.php :: AC3: the store's exclusion holds the store and nothing else / SPEC-012 | src/Hash/DataHashCheck.php :: check() (every store piece inside an exclusion, and that exclusion holding nothing else — amendment 7; past-end); src/Container/ManifestStoreBytes.php :: __construct() (merging) |
